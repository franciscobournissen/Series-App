...
namespace SeriesApp.Migrations
{
    ...
    [Migration("20250415154353_UpdateApiLog")]
    partial class UpdateApiLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SerieTrackingList", b =>
                {
                    ...
                    b.Property<Guid>("TrackingListId")
                        .HasColumnType("char(36)");

                    b.HasKey("SeriesId", "TrackingListId");

                    b.HasIndex("TrackingListId");
            ...
            modelBuilder.Entity("SeriesApp.Entities.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("SeriesApp.Entities.Serie", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("SeriesApp.Entities.TrackingList", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AppTrackingLists", (string)null);
                });

            modelBuilder.Entity("SeriesApp.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("SerieTrackingList", b =>
                {
                    ...
                    b.HasOne("SeriesApp.Entities.TrackingList", null)
                        .WithMany()
                        .HasForeignKey("TrackingListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SeriesApp.Entities.Notification", b =>
                {
                    b.HasOne("SeriesApp.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("SeriesApp.Entities.Rating", b =>
                {
                    b.HasOne("SeriesApp.Entities.Serie", "Serie")
                        .WithMany()
